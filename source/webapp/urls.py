...
from .views.views import IndexView, IssueView, IssueCreateView, issue_update_view, issue_delete_view
from .views.status_views import StatusView, StatusCreateView, status_update_view, status_delete_view
from .views.type_views import  TypeView, TypeCreateView, type_update_view, type_delete_view
from .views.project_views import ProjectIndexView, ProjectView, ProjectCreateView, project_update_view, \
    project_delete_view
